        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="text-neutral-400 text-sm leading-relaxed">
              Sınırlı sayıda üretilen, müze kalitesinde giclée baskılar.
            </p>
          </div>
          <div>
            <h4 className="text-sm font-medium mb-4">MENÜ</h4>
          ...
          <div>
            <h4 className="text-sm font-medium mb-4">İLETİŞİM</h4>
            <div className="space-y-3">
              <a href={`mailto:${email}`} className="flex items-center gap-2 text-neutral-400 hover:text-white text-sm">
                <Mail className="w-4 h-4" />
                {email}
              </a>
              {instagram && (
                <a href={instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-neutral-400 hover:text-white text-sm">
