...
const SphereImageGrid: React.FC<SphereImageGridProps> = ({
  ...
  const renderSpotlightModal = () => {
    if (!selectedImage || !showModal) return null;
  ...
  if (!isMounted) {
    return (
      <div
        className="bg-neutral-100 rounded-lg animate-pulse flex items-center justify-center"
  ...
  if (!images.length) {
    return (
      <div
        className="bg-neutral-50 rounded-lg border-2 border-dashed border-neutral-300 flex items-center justify-center"
        style={{ width: containerSize, height: containerSize }}
      >
