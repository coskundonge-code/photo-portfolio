...
const demoPhotos: Photo[] = [
  ...
  { id: '4', title: 'City Lights', url: 'https://images.unsplash.com/photo-1519501025264-65ba15a82390?w=800', project_id: '2', order_index: 4, created_at: '', updated_at: '' },
  { id: '5', title: 'Desert Sunset', url: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=800', project_id: '1', order_index: 5, created_at: '', updated_at: '' },
  { id: '6', title: 'Northern Lights', url: 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=800', project_id: '2', order_index: 6, created_at: '', updated_at: '' },
  { id: '7', title: 'Waterfall', url: 'https://images.unsplash.com/photo-1432405972618-c60b0225b8f9?w=800', project_id: '1', order_index: 7, created_at: '', updated_at: '' },
...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-primary">
      <Navigation projects={projects} siteName="LEVON BISS" />
