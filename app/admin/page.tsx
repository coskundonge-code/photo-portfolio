...
import { getPhotos, getProjects, getProducts, getOrders } from '@/lib/supabase';
    ...
    <div className="p-8">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {cards.map((card) => {
          ...
          return (
            <Link key={card.href} href={card.href} className="bg-neutral-900 border border-neutral-800 rounded-xl p-6 group hover:border-neutral-700 transition-colors">
